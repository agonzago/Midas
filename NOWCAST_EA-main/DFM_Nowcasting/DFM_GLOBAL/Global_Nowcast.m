...
%% User inputs.
series = 'GDPGPM' ; % Nowcasting Global real GDP (NGDPR) <GDS data>
% period = '2019q4'; % Forecasting target quarter
period = '2020q2'; % Forecasting target quarter
...
vintage_old = '2020-08-26'; datafile_old = fullfile('data','Global',[vintage_old '.xlsx']);
vintage_new = '2020-09-26_Q2'; datafile_new = fullfile('data','Global',[vintage_new '.xlsx']);
