...
period = '2020q1'; % Forecasting target quarter
...
vintage_old = '2020-03-10'; datafile_old = fullfile('data','Global',[vintage_old '.xlsx']);
vintage_new = '2020-03-24'; datafile_new = fullfile('data','Global',[vintage_new '.xlsx']);
