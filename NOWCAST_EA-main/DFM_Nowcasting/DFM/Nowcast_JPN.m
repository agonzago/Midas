...
period = '2020q3'; % Forecasting target quarter
...
vintage_old = '2020-06-22'; datafile_old = fullfile('data','Japan',[vintage_old '.xlsx']);
vintage_new = '2020-07-31'; datafile_new = fullfile('data','Japan',[vintage_new '.xlsx']);
